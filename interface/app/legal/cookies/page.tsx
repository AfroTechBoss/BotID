...
export default function Cookies() {
  return (
    <>
      {/* Full width so the local-storage table gets the screen — it is the substance of the page,
          and it is a table. The prose keeps a measure of its own rather than the page keeping one
          for it. */}
      <main style={{ padding: 'var(--space-8) var(--space-6)', flex: 1 }}>
        <h1 style={{ fontSize: 28 }}>Cookies &amp; local storage</h1>
        <p className="text-muted" style={{ fontSize: 12 }}>Last updated Aug 9, 2026</p>
        <p className="measure">No tracking cookies. No advertising cookies. No consent banner, because there is nothing here to consent to.</p>
        ...
        <p className="measure">A consent banner, if it becomes necessary, will be a bottom-anchored bar with equal-weight Accept and Decline buttons &mdash; no scrim, no scroll lock, never covering content on mobile.</p>
      </main>
    </>
  );
}
